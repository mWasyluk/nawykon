...
1. Do poprawnego działania wymagana jest platforma Android (min. 7.0) lub iOS (min. 15.1).
2. Aplikacja może wymagać zgody na wyświetlanie lokalnych powiadomień.
...
1. Aplikacja udostępniana jest w stanie "takim, jakim jest".
2. Usługodawca nie ponosi odpowiedzialności za utratę danych lokalnych.
3. Użytkownik ponosi pełną odpowiedzialność za korzystanie z Aplikacji i wprowadzane dane.

## § 6. Własność intelektualna

1. Wszystkie prawa autorskie do Aplikacji przysługują Usługodawcy.
2. Użytkownikowi przysługuje niewyłączna licencja na korzystanie z Aplikacji na własnym urządzeniu.
